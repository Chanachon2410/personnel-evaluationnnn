...
const EvaluatorAssignmentResult = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700 pb-20 print:p-0 print:space-y-4 print:pb-0">
      ...
      <div className="flex items-center gap-4 no-print">
        ...
        <div>
          <h1 className="text-2xl font-black text-gray-900">สรุปผลการประเมินรายบุคคล</h1>
          <p className="text-gray-500 font-medium">รายละเอียดคะแนนแยกตามตัวชี้วัด</p>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="space-y-4 print:space-y-2">
              <div className="flex items-center gap-3 bg-white/10 px-4 py-3 rounded-2xl w-fit border border-white/10 text-secondary print:py-1">
                ...
                <span className="font-medium text-white/60 uppercase text-[10px] tracking-widest">ผู้รับการประเมิน:</span> 
                <span className="font-black text-white">{resultsData.evaluateeName}</span>
              </div>
            </div>
          </div>
...
export default EvaluatorAssignmentResult;
